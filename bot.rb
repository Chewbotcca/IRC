...
bot = Cinch::Bot.new do
  configure do |c|
    ...
    # Load modules.
    c.plugins.plugins = [Minecraft, JoinChannel, PartChannel, Restart, RandomCat, MemeDB, TRBMB, ModifyConfig, NickServ, InviteToJoin, Eval, RonQuote, EBall, Bitcoin, QRCode, About, Update, Define, Synonym, Antonym, Die, WordRandom, B, Food, TableFlip, Grammar]
  end
end
# START THE BOT
bot.start
