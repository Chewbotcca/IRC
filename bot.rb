...
bot = Cinch::Bot.new do
  configure do |c|
    ...
    # Load modules.
    c.plugins.plugins = [UuidLookup, JoinChannel, PartChannel, ServerStatus, Ping, Uptime, Restart, RandomCat, MemeDB, TRBMB, ModifyConfig, NickServ, InviteToJoin, Eval, RonQuote, EBall, Bitcoin, QRCode, About, Update, Define, Synonym, Antonym, Die, WordRandom, B, Food, TableFlip, Grammar]
  end
end
# START THE BOT
bot.start
