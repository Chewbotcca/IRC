class Eval
  ...
  def execute(m, code)
    if m.user.host == CONFIG['ownerhost']
      ...
      m.reply 'An error was thrown (similar to a baseball). It crahsed in through your house window and had a message written on it. It says: "You do not have permission to evaluate!" Now you have to fix your window.'
    end
  end
end
