...
ModifyConfig | `!config [option] [setting]`            | None                                    | Change config options.
ModifyConfig | `!permissions [staff] [perm] [setting]` | None                                    | Change [staff] member's [permission] to [setting].
